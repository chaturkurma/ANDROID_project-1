...
public class FifthUniversity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fifth_university);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent ini = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.thinklamar.com/how-to-apply.html?utm_source=google&utm_medium=cpc&utm_campaign=BB-Brand&gclid=Cj0KCQiAtrnuBRDXARIsABiN-7CO9Um6oE8qtoEQICUJ79CspHGZBHPs7kUNCOU2CPdCphTYHKfs81gaAv5tEALw_wcB"));
                startActivity(ini);
