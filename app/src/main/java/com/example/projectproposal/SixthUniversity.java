...
public class SixthUniversity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sixth_university);
        ...
        BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent ini = new Intent(Intent.ACTION_VIEW, Uri.parse("https://admission.stanford.edu/apply/"));
                startActivity(ini);
